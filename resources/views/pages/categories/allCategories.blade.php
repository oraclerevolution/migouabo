    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
              <h5 class="txt-dark"> {{ count($categories) }} catégories  </h5>
            </div>
            <!-- Breadcrumb -->
                            ...
                            <div class="panel-body pa-0">
                                <article class="col-item">
                                    ...
                                    <div class="info">
                                        ...
                                        <br>
                                    <h6>Vendeuse : <a href="">{{ $category->sellerName }}</a></h6>
                                    <br>
                                        <a href=" {{ route('sellers.categories.sub-categories.index', ['seller'=> $category->id_seller,
                                                                                                    'category'=> $category->id] ) }} "
                                                                                                     class="btn btn-primary">Parourir</a>
                                    </div>
                                </article>
                            </div>
                        </div>	
