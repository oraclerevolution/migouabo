                ...
                <div class="panel panel-default card-view">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form action=" {{ route('sellers.categories.store', $sellers->id) }} " method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="seller" class="form-control" data-placeholder="Choose a Category" tabindex="1">
