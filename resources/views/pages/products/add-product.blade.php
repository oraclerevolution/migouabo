    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              <ol class="breadcrumb">
                <li><a href="index.html"> {{ $seller->name }} </a></li>
                ...
                <div class="panel panel-default card-view">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form action=" {{route('sellers.categories.sub-categories.products.store', ['seller'=>$seller->id,
                                                                                                            'category'=>$category->id,
                                                                                                            'sub_category'=>$subCategory->id])}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" id="description" name="description" class="form-control" placeholder="azerty qsdfgh wxcvbn">
                                                ...
                                                <div class="radio-list">
                                                    <div class="radio-inline pl-0">
                                                        <div class="radio radio-info">
                                                            <input type="radio" name="stock" id="radio1" value="0">
                                                            <label for="radio1">En stock</label>
                                                        </div>
                                                    </div>
                                                    <div class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input type="radio" name="stock" id="radio2" value="1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" id="price" placeholder="1500 fcfa">
                                                </div>
                                        ...
                                        <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="discount" value="0" name="discount" placeholder="0%">
                                                </div>
